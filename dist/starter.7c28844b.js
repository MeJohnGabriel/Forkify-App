...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _addRecipeViewJsDefault.default).renderMessageSuccess();
...
},{"core-js/modules/web.immediate.js":"bzsBv","./model.js":"cfHEn","regenerator-runtime/runtime":"f6ot0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./views/recipeView.js":"fLbry","./views/searchView.js":"5aK57","./views/resultsView.js":"lYFJn","./views/paginationView.js":"3kBPa","./views/bookmarksView.js":"2vc5x","./views/addRecipeView.js":"8Ye1u","./config.js":"7c2aR"}],"bzsBv":[function(require,module,exports,__globalThis) {
'use strict';
...
const loadRecipe = async function(id) {
    try {
        ...
        if (state.bookmarks.some((bkrmk)=>bkrmk.id === id)) state.recipe.bookmarked = true;
        else state.recipe.bookmarked = false;
        console.log(state.recipe);
    } catch (err) {
        //Temporary error handling
        console.error(`\u{274C}${err}`);
        throw err;
    }
};
...
const updateServings = function(newServings) {
    ...
    //Formula: newQt = oldQt * newServings / oldServings (e.g: 2 * 8 / 4 = 4)
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config":"7c2aR","./helpers":"2QjiY"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
const KEY = `15dbb82a-c061-4148-876b-64eba359eba0`;
...
export const getJSON = async function (url) {
  try {
    ...
    const response = await Promise.race([fetchApi, timeout(TIMEOUT_SEC)]);
    const data = await response.json();
    if (!response.ok) throw new Error(`${data.message} (${response.status})`);
    return data;
  } catch (err) {
...
},{"./config":"7c2aR","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f6ot0":[function(require,module,exports,__globalThis) {
/**
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener('click', function(e) {
            ...
            //only call handler when it meets this condition
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","url:../../img/icons.svg":"apwnT","fracty":"gsPKI","./view":"eFPgt"}],"apwnT":[function(require,module,exports,__globalThis) {
...
},{}],"eFPgt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg"); //Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class View {
    ...
    render(data, render = true) {
        //Error on search: Invalid search
  ...
  <div class="spinner">
   ...
   <div class="error">
    ...
    renderMessageSuccess(message = this._successMessage) {
        const markup = `
   <div class="recipe">
        <div class="message">
          <div>
...
},{"url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5aK57":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"./view":"eFPgt","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./previewView.js":"8rL4Y"}],"8rL4Y":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"eFPgt","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3kBPa":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    <button data-goto="${currentPage + 1}" class="btn--inline pagination__btn--next">
     <qqspan>Page ${currentPage + 1}</span>
       <svg class="search__icon">
...
},{"./view":"eFPgt","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2vc5x":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"eFPgt","./previewView.js":"8rL4Y","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8Ye1u":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"eFPgt","url:../../img/icons.svg":"apwnT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3cF9g","dGopa"], "dGopa", "parcelRequire3a11", {}, "./", "/")
